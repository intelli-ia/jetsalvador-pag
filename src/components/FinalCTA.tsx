...
export function FinalCTASection() {
  return (
    <section className="relative w-full py-16 md:py-36 bg-[#0A1628]">
      <div className="container mx-auto px-6 md:px-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="font-title text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-5 md:mb-6">
          ...
          >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 text-white/60 hover:text-white font-medium px-6 py-4 border border-white/15 hover:border-[#00B8D9]/40 rounded-full transition-all duration-300 text-sm md:text-base"
            >
